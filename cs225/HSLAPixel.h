...
namespace cs225 {
    ...
    public:
        ...
        /**
         * Constructs a default HSLAPixel. A default pixel is completely opaque (non-transparent) and white. 
         * Opaque implies that the alpha component of the pixel is 1.0. Lower alpha values are (semi-)transparent.
         */
        HSLAPixel();
